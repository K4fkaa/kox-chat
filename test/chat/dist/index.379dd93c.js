...
// Zmiana kolorku UWU======================================================================================================
const colorInput = _elementJs.getElement("kolor");
colorInput.addEventListener('input', _colorDefault.default.colorChange);
const textInput = _elementJs.getElement('kolor2');
textInput.addEventListener('input', _colorDefault.default.textColor);
// Zmiana kolorku UWU Koniec===============================================================================================
// Wiadomości pogjump======================================================================================================
const sendEnter = _elementJs.getElement('yes');
sendEnter.addEventListener('submit', _chatJs.sendMess);
const sendButton = _elementJs.getElement('send');
sendButton.addEventListener('click', _chatJs.sendMess); // Wiadomości pogjump koniec==================================================================================================
 //Notatki=====================================================================================================================
 //!!!Do zrobienia!!!
 //
...
},{"./element.js":"4mzdH","./color":"9gmau","./chat.js":"2NHZ0","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"4mzdH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"9gmau":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _elementJs = require("./element.js");
const colorChange = (event)=>{
    const color = _elementJs.getElement('kolor').value;
    document.getElementsByName('1').forEach((colorto)=>{
        colorto.setAttribute("style", `background-color:${color}`);
    });
};
const textColor = (event)=>{
    const color = _elementJs.getElement('kolor2').value;
...
},{"./element.js":"4mzdH","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"2NHZ0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sendMess", ()=>sendMess
);
var _elementJs = require("./element.js");
...
const createDiv = (text, user)=>{
    _elementJs.getElement('wiadomosci').appendChild(addToDiv(createSpan(`${user}: `, 'user'), createSpan(text)));
};
...
const sendMess = (event)=>{
    ...
    const text = _elementJs.getElement('textinput').value;
    const user = _elementJs.getElement('nick').value;
    text === '' || user === '' ? alert("💡 | Najpierw wprowadz wiadomosc nickname") : sendMessageToServer(text, user);
    _elementJs.getElement('textinput').value = '';
};

},{"./element.js":"4mzdH","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["lBB98","hD4hw"], "hD4hw", "parcelRequire94c2")
