...
colorInput.addEventListener('input', _color.colorChange);
...
},{"./color":"fKNfD","./chat.js":"ggANl"}],"fKNfD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "colorChange", ()=>colorChange
);
...
},{}],"ggANl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sendMess", ()=>sendMess
);
const ws = new WebSocket('wss://localhost:4300');
ws.onopen = ()=>{
...
ws.onmessage = (messageWS)=>{
    ...
    const messages = JSON.parse(messageWS.data);
    createDiv(messages);
};
...
const sendMess = (event)=>{
    ...
    text === '' ? alert("💡 | Najpierw wprowadz wiadomosc") : sendMessageToServer(text);
